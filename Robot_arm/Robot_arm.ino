...
Adafruit_PWMServoDriver hemel = Adafruit_PWMServoDriver();
...
void setup() {
  ...
  hemel.begin();
  hemel.setPWMFreq(60);
  hemel.setPWM(servo1, 0, 330);
  hemel.setPWM(servo2, 0, 150);
  hemel.setPWM(servo3, 0, 300);
  hemel.setPWM(servo4, 0, 410);
  delay(3000);
}
